...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/Css/inventoryStatistic2.css">
        <style>
            #categoryChart {
                width: 100% !important;
                max-width: 600px;
    ...
    <body>
        <div class="container d-flex">
            ...
            <div class="wrapper">
                ...
                <div class="text-center mt-2 text-secondary" style="font-size: 15px; font-weight: bold;">
