...
<head>
    ...
    <style>
        ...
        .back-btn { background-color: red; color: white; padding: 8px 12px; border: none; text-decoration: none; border-radius: 5px; margin-bottom: 10px; }
        ...
        button { padding: 8px 12px; background-color: green; color: white; border: none; border-radius: 4px; margin-left: 5px; }
        table { width: 100%; border-collapse: collapse; margin-top: 10px; }
        th, td { border: 1px solid #ddd; padding: 10px; text-align: center; }
        th { background-color: #f4f4f4; }
        .status-tag { padding: 5px 10px; border-radius: 20px; color: white; font-size: 0.9em; }
        .in-stock { background-color: #28a745; }
        .low-stock { background-color: #ffc107; color: #000; }
        .out-of-stock { background-color: #dc3545; }
        canvas { margin-top: 30px; width: 100%; max-width: 600px; display: block; margin-left: auto; margin-right: auto; }
    </style>
</head>
<body>
