    ...
    <body>
        <div class="" style="width: 95%; border-radius: 15px; margin-top: 1%; margin-left: 2.5%; background-color: #fff; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.05);">
            ...
            <div style="display: flex; border-radius: 10px;">
                ...
                <div class="product-scroll-wrapper">
                    <!-- Nút trái -->
                    <button style = "" onclick="scrollLeft()" class="scroll-btn scroll-left-discount">←</button>

                    <!-- Danh sách sản phẩm -->
                    <div id="product-scroll-discount" style = "">
                    ...
                    <!-- Nút phải -->
                    <button style = "margin-left: 2%;" onclick="scrollRight()" class="scroll-btn scroll-right-discount">→</button>
                </div>
            </div>
        </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                const container = document.getElementById('product-scroll-discount');
                const scrollAmount = container.clientWidth;

                document.querySelector('.scroll-left-discount').addEventListener('click', () => {
                    container.scrollBy({left: -scrollAmount, behavior: 'smooth'});
                });

                document.querySelector('.scroll-right-discount').addEventListener('click', () => {
                    container.scrollBy({left: scrollAmount, behavior: 'smooth'});
                });
            });
        </script>
