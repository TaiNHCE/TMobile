...
<head>
    ...
    <style>
        * {
        ...
        .stat-icon.orders { background: #00bcd4; }
        .stat-icon.products { background: #4caf50; }
        .stat-icon.stock { background: #ff9800; }
        .stat-icon.customers { background: #9c27b0; }
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        <div class="stat-info">
                            ...
                            <div class="number">${todayOrders != null ? todayOrders : 24}</div>
                        </div>
                    ...
                    <div class="stat-card">
                        <div class="stat-info">
                            <h3>Products Sold</h3>
                            <div class="number">${productsSold != null ? productsSold : 156}</div>
                        </div>
                    ...
                    <div class="stat-card">
                        <div class="stat-info">
                            <h3>Low Stock</h3>
                            <div class="number">${lowStockAlerts != null ? lowStockAlerts : 8}</div>
                        </div>
                    ...
                    <div class="stat-card">
                        <div class="stat-info">
                            <h3>New Customers</h3>
                            <div class="number">${newCustomers != null ? newCustomers : 12}</div>
                        </div>
