        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="action-buttons">
                    ...
                    <form action="RejectProductServlet" method="post" style="display: inline;" onsubmit="return confirm('Are you sure you want to <%= product.isIsActive() ? "DEACTIVATE" : "REJECT" %> this product?');">
                        <input type="hidden" name="productId" value="<%= product.getProductId() %>">
