...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/Css/supplierList5.css"> <!-- Tái sử dụng -->
            ...
            <div class="card mx-auto shadow" style="max-width: 700px;">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-borderless">
                        ...
                        <tr><th>Min Order:</th><td><%= currencyVN.format(v.getMinOrderAmount()) + " đ"%></td></tr>
                        <tr><th>Max Discount:</th><td><%= currencyVN.format(v.getMaxDiscountAmount()) + " đ"%></td></tr>
