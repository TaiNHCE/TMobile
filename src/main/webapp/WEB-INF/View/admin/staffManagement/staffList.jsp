...
<html>
    ...
    <body>
        ...
        <a href="CreateStaffServlet" class="btn btn-primary">Create Staff</a>
        <div class="container">
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a href="UpdateStaffServlet?action=update&id=<%= sta.getStaffID()%>" class="btn btn-primary">Update</a>
