...
//    <===================================================== GIA KHIÊM ======================================================>
    ...
    public List<Category> getAllCategories() {
        String sql = "SELECT categoryId, categoryName, descriptionCategory, createdAt, imgUrlLogo, isActive FROM Categories";
        ...
        try ( PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                c.setDescriptionCategory(rs.getString("descriptionCategory"));
   ...
   public List<Brand> getAllBrands() {
    String sql = "SELECT brandId, brandName, desciptionBrand, categoryID, imgUrlLogo FROM Brands";
    ...
    try (PreparedStatement ps = conn.prepareStatement(sql)) {
        ...
        while (rs.next()) {
            ...
            b.setDesciptionBrand(rs.getString("desciptionBrand"));
            b.setCategoryID(rs.getInt("categoryID"));
            b.setImgUrlLogo(rs.getString("imgUrlLogo"));
            list.add(b);
        }
    } catch (SQLException e) {
        e.printStackTrace();
