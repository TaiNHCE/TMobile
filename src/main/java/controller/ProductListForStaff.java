    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("list")) {
            ...
            try {
                ...
                List<ProductDetail> productDetailList = dao.getProductDetailById(id); // Lấy danh sách ProductDetail
                List<Suppliers> supList = dao.getAllSuppliers(); // Lấy danh sách Suppliers
                List<Category> cateList = dao.getAllCategories(); // Lấy danh sách Suppliers
                List<Brand> braList = dao.getAllBrands(); // Lấy danh sách Suppliers
                request.setAttribute("data", product);
                request.setAttribute("productDetailList", productDetailList);
                request.setAttribute("supList", supList);
                request.setAttribute("cateList", cateList);
                request.setAttribute("braList", braList);
                request.getRequestDispatcher("/WEB-INF/View/staff/productManagement/productDetail.jsp").forward(request, response);
