...
public class RegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean emailSent = EmailService.sendOTPEmail(email, "REGISTER");
        int otpCode = EmailService.getCurrentOTP(email);
        OTPManager otpManager = new OTPManager(otpCode, 5); // thời gian hết hạn: 5 phút
