...
public class AdminUpdateProductDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (productId != -1) {
            ...
            request.getRequestDispatcher("/WEB-INF/View/admin/productManagement/updateProduct/updateTechnicalSpecs/updateDetail.jsp").forward(request, response);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (productIdStr != null) {
            ...
            if (checkUpdate) {
                response.sendRedirect("AdminUpdateProductDetail?productId=" + productId + "&success=1");
            } else {
                response.sendRedirect("AdminUpdateProductDetail?productId=" + productId + "&error=1");
            }
        }
        //        <====================================== Xử lý thông tin ===========================================>
