 ...
 * @author HP - Gia Khiêm
 */
@WebServlet(name = "StaffAddProductServlet", urlPatterns = {"/StaffAddProduct"})
public class StaffAddProductServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/View/staff/productManagement/addProduct/staffAddProduct.jsp").forward(request, response);
    }
